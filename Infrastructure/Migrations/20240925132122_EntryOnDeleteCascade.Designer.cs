...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240925132122_EntryOnDeleteCascade")]
    partial class EntryOnDeleteCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.ReportEntry", b =>
                {
                    b.HasOne("Core.Entities.InternshipReport", "InternshipReport")
                        .WithMany("Entries")
                        .HasForeignKey("InternshipReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InternshipReport");
                });
